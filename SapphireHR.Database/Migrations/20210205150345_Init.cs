    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyLeavePolicies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployerRate = table.Column<int>(type: "int", nullable: false),
                    PensionManager = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeePensions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeTimetables", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    FromCompany = table.Column<int>(type: "int", nullable: false),
                    ToCompany = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarryOverMax = table.Column<int>(type: "int", nullable: false),
                    EarnedLeave = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LookupSort = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RankId = table.Column<int>(type: "int", nullable: false),
                    ReadHoliday = table.Column<bool>(type: "bit", nullable: false),
                    ReadLeave = table.Column<bool>(type: "bit", nullable: false),
                    ReadAssets = table.Column<bool>(type: "bit", nullable: false),
                    ReadTimesheet = table.Column<bool>(type: "bit", nullable: false),
                    WriteHolidays = table.Column<bool>(type: "bit", nullable: false),
                    WriteLeave = table.Column<bool>(type: "bit", nullable: false),
                    WriteAssets = table.Column<bool>(type: "bit", nullable: false),
                    WriteTimesheet = table.Column<bool>(type: "bit", nullable: false),
                    DeleteHolidays = table.Column<bool>(type: "bit", nullable: false),
                    DeleteLeave = table.Column<bool>(type: "bit", nullable: false),
                    DeleteAssets = table.Column<bool>(type: "bit", nullable: false),
                    DeleteTimesheet = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RankPermissions", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeEmergencies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeEmergencies_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    TemplateCreation = table.Column<bool>(type: "bit", nullable: false),
                    CollectionOfPersonalData = table.Column<bool>(type: "bit", nullable: false),
                    DataMigration = table.Column<bool>(type: "bit", nullable: false),
                    MeetingExecutives = table.Column<bool>(type: "bit", nullable: false),
                    MeetingColleagues = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkillGrades", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SkillGrades_Skills_SkillTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobProfiles_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobProfiles_RankPermissions_RankId",
                        column: x => x.RankId,
                        principalTable: "RankPermissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobCategories_JobProfiles_JobProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobProfessions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobProfessions_JobProfiles_JobProfileId",
                        column: x => x.JobProfileId,
                        principalTable: "JobProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillGradeId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobSkillLevels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobSkillLevels_JobProfiles_JobProfileId",
                        column: x => x.JobProfileId,
                        principalTable: "JobProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobSkillLevels_SkillGrades_SkillGradeId",
                        column: x => x.SkillGradeId,
                        principalTable: "SkillGrades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobSkillLevels_Skills_SkillsId",
                        column: x => x.SkillsId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationFaceToViews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationFaceToViews_Applications_ApplicationId",
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationNegotiations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ApplicationId = table.Column<int>(type: "int", nullable: false),
                    RelatedTaskCompleted = table.Column<bool>(type: "bit", nullable: false),
                    NegotiationCompleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationNegotiations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationNegotiations_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ApplicationId = table.Column<int>(type: "int", nullable: false),
                    JobSkillLevelId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationSkills", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.JobSkillLevelId,
                        principalTable: "JobSkillLevels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationSkills_SkillGrades_GradeId",
                        column: x => x.GradeId,
                        principalTable: "SkillGrades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationSkills_GradeId",
                table: "ApplicationSkills",
                column: "GradeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeEmergencies_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobCategories_JobProfileId",
                table: "JobCategories",
                column: "JobProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_JobProfessions_JobProfileId",
                table: "JobProfessions",
                column: "JobProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_JobProfiles_DepartmentId",
                table: "JobProfiles",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_JobProfiles_RankId",
                table: "JobProfiles",
                column: "RankId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobSkillLevels_JobProfileId",
                table: "JobSkillLevels",
                column: "JobProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_JobSkillLevels_SkillGradeId",
                table: "JobSkillLevels",
                column: "SkillGradeId");

            migrationBuilder.CreateIndex(
                name: "IX_JobSkillLevels_SkillsId",
                table: "JobSkillLevels",
                column: "SkillsId");
